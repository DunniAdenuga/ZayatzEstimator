...
public class ZayatzEstimator {
    private PrivateTable myTable;
    
    //User-defined sampling fraction
    private double samplingFrac; //in real life use, this would be n/N
    //n - sample size(size of data set to be given to researcher), N - population size (e.g number of patients at CHOP)
    
    public static void main(String[] args) throws FileNotFoundException, SQLException, ClassNotFoundException  {
        DataFly dataFly = new DataFly();
        ZayatzEstimator zayatzEstimator = new ZayatzEstimator();
                
        //Set up connection with AudGen Database using method from datafly
        ...
        /*
        For test purposes, uncomment to try with generalized data
    ...
    /**
     * In this case, the AudGen DB represents the population so, 
     * a random sample (a dataset to be released) is generated by sampling frac
     * @param myTable - table sample is generated from
     * @return 
     */
    ...
    /**
     * Divide sample into equivalence classes using the specified quasi 
     * identifiers (QI) e.g if QI is {Sex, Age}, all records with
     * Male 17 year old would be in the same equivalence class
     * @param sample
     * @return an hasmap of all equivalence classes and their sizes
     */
    ...
    /**
     * Find size of largest equivalence class in a sample
     * @param sample
     * @return 
     */
